// scripts/apply-batch2-landings.cjs
// Batch 2: veterinary-clinic, accounting-firm. See apply-batch1-landings.cjs for notes.
const fs = require("fs");
...
const allDocs = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch2-docs.json"), "utf8"));
