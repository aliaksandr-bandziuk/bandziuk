// scripts/apply-batch3-landings.cjs
// Batch 3: architecture-studio, photographer, language-school. See apply-batch1-landings.cjs for notes.
const fs = require("fs");
...
const allDocs = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch3-docs.json"), "utf8"));
