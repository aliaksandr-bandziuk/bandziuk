// scripts/apply-batch4-landings.cjs
// Batch 4: fitness-studio, cleaning-company, restaurant. See apply-batch1-landings.cjs for notes.
const fs = require("fs");
...
const allDocs = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch4-docs.json"), "utf8"));
