// scripts/apply-batch5-landings.cjs
// Batch 5: hotel-website, travel-agency, logistics-company. See apply-batch1-landings.cjs for notes.
const fs = require("fs");
...
const allDocs = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch5-docs.json"), "utf8"));
