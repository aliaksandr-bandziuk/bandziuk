// scripts/apply-batch6-landings.cjs
// Batch 6: recruitment-agency, manufacturing-company, startup-website. See apply-batch1-landings.cjs for notes.
const fs = require("fs");
...
const allDocs = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch6-docs.json"), "utf8"));
