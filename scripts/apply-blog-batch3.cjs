...
const allDocs = JSON.parse(fs.readFileSync(path.join(DRAFTS, "_blog-batch3-docs.json"), "utf8"));
...
const BACKFILL_PLAN = {
  "blog-psychologist-website-checklist": ["blog-website-no-leads"],
  "blog-psychologist-website-checklist.pl": ["blog-website-no-leads.pl"],
  "blog-psychologist-website-checklist.ru": ["blog-website-no-leads.ru"],
  "blog-auto-repair-website-cost": ["blog-slow-website"],
  "blog-auto-repair-website-cost.pl": ["blog-slow-website.pl"],
  "blog-auto-repair-website-cost.ru": ["blog-slow-website.ru"],
  "blog-platform-choice": ["blog-slow-website"],
  "blog-platform-choice.pl": ["blog-slow-website.pl"],
  "blog-platform-choice.ru": ["blog-slow-website.ru"],
};
