// scripts/assemble-batch3-landings.cjs
// Batch 3: architecture-studio, photographer, language-school. See assemble-batch1-landings.cjs for notes.
const fs = require("fs");
...
const parsed = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch3-parsed.json"), "utf8"));

const LANDINGS = [
  {
    name: "architecture-studio",
    baseId: "singlepage-architecture-studio",
    slug: { en: "architecture-studio-website", pl: "strona-dla-biura-architektonicznego", ru: "sait-dlya-arhitekturnogo-byuro" },
  },
  {
    name: "photographer",
    baseId: "singlepage-photographer",
    slug: { en: "photographer-website", pl: "strona-dla-fotografa", ru: "sait-dlya-fotografa" },
  },
  {
    name: "language-school",
    baseId: "singlepage-language-school",
    slug: { en: "language-school-website", pl: "strona-dla-szkoly-jezykowej", ru: "sait-dlya-yazykovoy-shkoly" },
  },
];
...
fs.writeFileSync(path.resolve(__dirname, "../drafts/_batch3-docs.json"), JSON.stringify(output, null, 2));
...
console.log("\nFull resolved docs written to drafts/_batch3-docs.json");
