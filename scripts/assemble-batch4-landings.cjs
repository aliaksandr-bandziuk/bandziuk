// scripts/assemble-batch4-landings.cjs
// Batch 4: fitness-studio, cleaning-company, restaurant. See assemble-batch1-landings.cjs for notes.
const fs = require("fs");
...
const parsed = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch4-parsed.json"), "utf8"));

const LANDINGS = [
  {
    name: "fitness-studio",
    baseId: "singlepage-fitness-studio",
    slug: { en: "fitness-studio-website", pl: "strona-dla-studia-fitness", ru: "sait-dlya-fitnes-studii" },
  },
  {
    name: "cleaning-company",
    baseId: "singlepage-cleaning-company",
    slug: { en: "cleaning-company-website", pl: "strona-dla-firmy-sprzatajacej", ru: "sait-dlya-kliningovoy-kompanii" },
  },
  {
    name: "restaurant",
    baseId: "singlepage-restaurant",
    slug: { en: "restaurant-website", pl: "strona-dla-restauracji", ru: "sait-dlya-restorana" },
  },
];
...
fs.writeFileSync(path.resolve(__dirname, "../drafts/_batch4-docs.json"), JSON.stringify(output, null, 2));
...
console.log("\nFull resolved docs written to drafts/_batch4-docs.json");
