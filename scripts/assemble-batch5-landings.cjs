// scripts/assemble-batch5-landings.cjs
// Batch 5: hotel-website, travel-agency, logistics-company. See assemble-batch1-landings.cjs for notes.
const fs = require("fs");
...
const parsed = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch5-parsed.json"), "utf8"));

const LANDINGS = [
  {
    name: "hotel-website",
    baseId: "singlepage-hotel-website",
    slug: { en: "hotel-website", pl: "strona-dla-hotelu", ru: "sait-dlya-otelya" },
  },
  {
    name: "travel-agency",
    baseId: "singlepage-travel-agency",
    slug: { en: "travel-agency-website", pl: "strona-dla-biura-podrozy", ru: "sait-dlya-turagentstva" },
  },
  {
    name: "logistics-company",
    baseId: "singlepage-logistics-company",
    slug: { en: "logistics-company-website", pl: "strona-dla-firmy-transportowej", ru: "sait-dlya-transportnoy-kompanii" },
  },
];
...
fs.writeFileSync(path.resolve(__dirname, "../drafts/_batch5-docs.json"), JSON.stringify(output, null, 2));
...
console.log("\nFull resolved docs written to drafts/_batch5-docs.json");
