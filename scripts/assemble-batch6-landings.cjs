// scripts/assemble-batch6-landings.cjs
// Batch 6: recruitment-agency, manufacturing-company, startup-website. See assemble-batch1-landings.cjs for notes.
const fs = require("fs");
...
const parsed = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch6-parsed.json"), "utf8"));

const LANDINGS = [
  {
    name: "recruitment-agency",
    baseId: "singlepage-recruitment-agency",
    slug: { en: "recruitment-agency-website", pl: "strona-dla-agencji-rekrutacyjnej", ru: "sait-dlya-kadrovogo-agentstva" },
  },
  {
    name: "manufacturing-company",
    baseId: "singlepage-manufacturing-company",
    slug: { en: "manufacturing-company-website", pl: "strona-dla-firmy-produkcyjnej", ru: "sait-dlya-proizvodstvennoy-kompanii" },
  },
  {
    name: "startup-website",
    baseId: "singlepage-startup-website",
    slug: { en: "startup-website", pl: "strona-dla-startupu", ru: "sait-dlya-startapa" },
  },
];
...
fs.writeFileSync(path.resolve(__dirname, "../drafts/_batch6-docs.json"), JSON.stringify(output, null, 2));
...
else console.log("OK — all noindex/slug/block-order checks passed for all 3 landings x 3 locales.");
...
console.log("\nFull resolved docs written to drafts/_batch6-docs.json");
