// scripts/assemble-batch7-landings.cjs
// Batch 7: web-development-warsaw, platform-migration. See assemble-batch1-landings.cjs for notes.
const fs = require("fs");
...
const parsed = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/_batch7-parsed.json"), "utf8"));

const LANDINGS = [
  {
    name: "web-development-warsaw",
    baseId: "singlepage-web-development-warsaw",
    slug: { en: "web-development-warsaw", pl: "tworzenie-stron-internetowych-warszawa", ru: "razrabotka-saitov-varshava" },
  },
  {
    name: "platform-migration",
    baseId: "singlepage-platform-migration",
    slug: { en: "website-platform-migration", pl: "migracja-strony-na-inna-platforme", ru: "perenos-saita-na-druguyu-platformu" },
  },
];
...
fs.writeFileSync(path.resolve(__dirname, "../drafts/_batch7-docs.json"), JSON.stringify(output, null, 2));
...
else console.log("OK — all noindex/slug/block-order checks passed for all 2 landings x 3 locales.");
...
console.log("\nFull resolved docs written to drafts/_batch7-docs.json");
