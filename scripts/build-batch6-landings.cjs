// scripts/build-batch6-landings.cjs
// Batch 6: recruitment-agency, manufacturing-company, startup-website. See build-batch1-landings.cjs for notes.
const fs = require("fs");
const path = require("path");
const { parseTaggedFile } = require("./lib/landing-parser.cjs");

const LANDINGS = [
  { name: "recruitment-agency", file: "landing-recruitment-agency-tagged-content.md" },
  { name: "manufacturing-company", file: "landing-manufacturing-company-tagged-content.md" },
  { name: "startup-website", file: "landing-startup-website-tagged-content.md" },
];
...
fs.writeFileSync(path.resolve(__dirname, "../drafts/_batch6-parsed.json"), JSON.stringify(result, null, 2));
...
console.log("\nParsed JSON written to drafts/_batch6-parsed.json");
