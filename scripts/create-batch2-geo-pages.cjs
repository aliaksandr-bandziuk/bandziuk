// Batch 2 of the geo country pages: Portugal, Spain, Thailand (EN + RU, no PL — dev pages).
// Same pattern as scripts/create-batch1-geo-pages.cjs.
const fs = require("fs");
...
const ONLINE_BOOKING_SLUG = { en: "website-with-online-booking", ru: "sait-s-onlain-zapisyu" };
const FELGILAB_CASE_SLUG = { en: "felgilab-wordpress-rebuild", ru: "pererabotka-saita-felgilab-wordpress" };
...
function onlineBookingUrl(lang) { return `${prefix(lang)}/${ONLINE_BOOKING_SLUG[lang]}`; }
function felgilabCaseUrl(lang) { return `${prefix(lang)}/portfolio/${FELGILAB_CASE_SLUG[lang]}`; }

// ---------- Per-page config ----------
const PAGES = [
  {
    name: "Portugal",
    file: "geo-portugal-tagged-content.md",
    banner: "geo-portugal-banner.jpg",
    id: { en: "singlepage-portugal", ru: "singlepage-portugal.ru" },
    areaServed: ["Portugal"],
    links: {
      content: [
        { anchor: { en: "A property catalogue I built for exactly this kind of audience runs in four languages", ru: "Каталог недвижимости, который я делал ровно под такую аудиторию, работает на четырёх языках" }, url: cyprusCaseUrl },
      ],
      faq: [
        { anchor: { en: "a multi-page multilingual site", ru: "многостраничный мультиязычный" }, url: multilingualUrl },
        { anchor: { en: "What's worth moving is the share of guests who already know your name", ru: "Переносить стоит долю гостей, которые уже знают ваше название" }, url: onlineBookingUrl },
      ],
    },
  },
  {
    name: "Spain",
    file: "geo-spain-tagged-content.md",
    banner: "geo-spain-banner.jpg",
    id: { en: "singlepage-spain", ru: "singlepage-spain.ru" },
    areaServed: ["Spain"],
    links: {
      content: [
        { anchor: { en: "it's an architectural change", ru: "а архитектурное изменение" }, url: multilingualUrl },
        { anchor: { en: "I've built for that last pattern directly", ru: "Под последнее поведение я строил напрямую" }, url: cyprusCaseUrl },
        { anchor: { en: "Different country, same behaviour.", ru: "Страна другая, поведение то же." }, url: geoHubUrl },
        { anchor: { en: "increasingly ask an AI assistant before they open a single site", ru: "всё чаще спрашивают ИИ-ассистента прежде, чем открыть хоть один сайт" }, url: aiReadinessUrl },
      ],
      faq: [
        { anchor: { en: "with the figure depending on how many languages and how much functionality", ru: "сумма зависит от количества языков и объёма функциональности" }, url: costArticleUrl },
      ],
    },
  },
  {
    name: "Thailand",
    file: "geo-thailand-tagged-content.md",
    banner: "geo-thailand-banner.jpg",
    id: { en: "singlepage-thailand", ru: "singlepage-thailand.ru" },
    areaServed: ["Thailand"],
    links: {
      content: [
        { anchor: { en: "The multilingual structure is the same work regardless of which languages you land on", ru: "Мультиязычная структура — одна и та же работа независимо от того, на каких языках вы остановитесь" }, url: multilingualUrl },
        { anchor: { en: "a four-language site for a Warsaw workshop included Ukrainian alongside Polish, English and Russian", ru: "четырёхъязычный сайт варшавской мастерской включал украинский наряду с польским, английским и русским" }, url: felgilabCaseUrl },
      ],
      faq: [
        { anchor: { en: "depending on languages and functionality", ru: "в зависимости от языков и функциональности" }, url: costArticleUrl },
      ],
    },
  },
];
