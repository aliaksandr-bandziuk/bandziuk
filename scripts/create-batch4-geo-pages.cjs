// Batch 4 of the geo country pages: Netherlands, Ireland, France, Italy (EN + PL + RU — promotion pages).
// Ireland -> UK mutual link: UK's published content has no reverse passage (flagged to owner),
// so only the Ireland -> UK direction is built here.
// France -> Switzerland link deferred: Switzerland isn't published yet (banner missing).
const fs = require("fs");
...
function parsePromoPageFile(mdPath) {
  ...
  // (confirmed in the Germany file in batch 3) — a real section boundary is always
  // followed by a "[TAG]" line, never a bare "PL:"/"RU:" marker.
...
const COST_ARTICLE_SLUG = { en: "multilingual-website-cost", pl: "ile-kosztuje-strona-wielojezyczna", ru: "skolko-stoit-multiyazychnyi-sait" };
...
const CHATGPT_ARTICLE_SLUG = { en: "how-clients-find-you-through-chatgpt", pl: "jak-klienci-znajduja-specjalistow-przez-chatgpt", ru: "kak-klienty-nahodyat-cherez-chatgpt" };
const HIGH_VALUE_CLIENTS_ARTICLE_SLUG = { en: "high-value-clients-dont-click-ads", pl: "drodzy-klienci-nie-klikaja-w-reklamy", ru: "dorogie-klienty-ne-klikayut-po-reklame" };
...
function highValueClientsArticleUrl(lang) { return `${prefix(lang)}/blog/${HIGH_VALUE_CLIENTS_ARTICLE_SLUG[lang]}`; }

// ---------- Per-page config ----------
const PAGES = [
  {
    name: "Netherlands",
    file: "geo-promo-netherlands-tagged-content.md",
    banner: "geo-promo-netherlands-banner.jpg",
    id: { en: "singlepage-seo-netherlands", pl: "singlepage-seo-netherlands.pl", ru: "singlepage-seo-netherlands.ru" },
    areaServed: ["Netherlands"],
    links: {
      content: [
        { anchor: { en: "Dutch-language sources are a fraction of the English-language pool", pl: "Źródła niderlandzkojęzyczne to ułamek puli angielskiej", ru: "Голландскоязычных источников — доля от английского массива" }, url: aiReadinessUrl },
      ],
      faq: [
        { anchor: { en: "Anyone telling you Dutch and German can share a keyword strategy is guessing.", pl: "Kto mówi Wam, że niderlandzki i niemiecki mogą dzielić strategię fraz, zgaduje.", ru: "Тот, кто говорит вам, что голландский и немецкий могут делить стратегию запросов, гадает." }, url: germanyPageUrl },
      ],
    },
  },
  {
    name: "Ireland",
    file: "geo-promo-ireland-tagged-content.md",
    banner: "geo-promo-ireland-banner.jpg",
    id: { en: "singlepage-seo-ireland", pl: "singlepage-seo-ireland.pl", ru: "singlepage-seo-ireland.ru" },
    areaServed: ["Ireland"],
    links: {
      content: [
        { anchor: { en: "If your buyers are actually British, use the other page", pl: "Jeśli Wasi klienci są w rzeczywistości brytyjscy, użyjcie tamtej strony", ru: "Если ваши покупатели на самом деле британские, вам нужна соседняя страница" }, url: ukPageUrl },
        { anchor: { en: "The English-language AI answer layer is the most developed and most contested there is.", pl: "Anglojęzyczna warstwa odpowiedzi AI jest najbardziej rozwinięta i najbardziej zatłoczona ze wszystkich.", ru: "Англоязычный слой ИИ-ответов самый развитый и самый занятый из всех." }, url: aiReadinessUrl },
      ],
      faq: [],
    },
  },
  {
    name: "France",
    file: "geo-promo-france-tagged-content.md",
    banner: "geo-promo-france-banner.jpg",
    id: { en: "singlepage-seo-france", pl: "singlepage-seo-france.pl", ru: "singlepage-seo-france.ru" },
    areaServed: ["France"],
    links: {
      content: [
        { anchor: { en: "Every other market on this list is entered on its own terms.", pl: "Na każdy inny rynek z tej listy wchodzi się na jego własnych warunkach.", ru: "На любой другой рынок из списка заходят на его собственных условиях." }, url: geoHubUrl },
        { anchor: { en: "The French-language source pool is substantial — far larger than Dutch or Swiss-market French — but a fraction of the English one.", pl: "Francuskojęzyczna pula źródeł jest znacząca — znacznie większa niż niderlandzka czy szwajcarsko-francuska — ale stanowi ułamek angielskiej.", ru: "Франкоязычная база источников значительна — заметно больше голландской или швейцарско-французской, — но составляет долю от английской." }, url: aiReadinessUrl },
        { anchor: { en: "a French version is built once and adapted several times, and adaptation is a fraction of the cost of a new language", pl: "wersję francuską buduje się raz, a adaptuje kilka razy, przy czym adaptacja kosztuje ułamek nowego języka", ru: "французская версия строится один раз и адаптируется несколько раз, а адаптация стоит долю от нового языка" }, url: costArticleUrl },
      ],
      faq: [],
    },
  },
  {
    name: "Italy",
    file: "geo-promo-italy-tagged-content.md",
    banner: "geo-promo-italy-banner.jpg",
    id: { en: "singlepage-seo-italy", pl: "singlepage-seo-italy.pl", ru: "singlepage-seo-italy.ru" },
    areaServed: ["Italy"],
    links: {
      content: [
        { anchor: { en: "Most of the geography pages on this site describe mechanics rather than local experience", pl: "Większość stron geograficznych na tej witrynie opisuje mechanikę, a nie lokalne doświadczenie", ru: "Большинство географических страниц на этом сайте описывают механику, а не местный опыт" }, url: geoHubUrl },
        { anchor: { en: "The Italian-language source pool is considerably smaller than the English one", pl: "Włoskojęzyczna pula źródeł jest znacznie mniejsza od angielskiej", ru: "Италоязычная база источников заметно меньше английской" }, url: aiReadinessUrl },
        { anchor: { en: "A client in Milan found this site through an AI assistant rather than a search engine", pl: "Klient z Mediolanu znalazł tę stronę przez asystenta AI, a nie przez wyszukiwarkę", ru: "Клиент из Милана нашёл этот сайт через ИИ-ассистента, а не через поисковую систему" }, url: chatgptArticleUrl },
        { anchor: { en: "wrote with a full list of requirements, and we signed two days later", pl: "napisał z pełną listą wymagań, a dwa dni później podpisaliśmy umowę", ru: "написал с полным списком требований, и через два дня мы подписали договор" }, url: highValueClientsArticleUrl },
      ],
      faq: [],
    },
  },
