// scripts/create-website-redesign-page.cjs
//
// Создаёт страницу услуги «редизайн сайта» в трёх локалях плюс документ
// переводов. Основание: drafts/services-audit-2026-09.md — «website redesign
// services» 6 600 в США и 1 300 в Великобритании при сложности 10, своей
// страницы нет, а статья по теме уже стоит на 29-й позиции.
//
//   node scripts/create-website-redesign-page.cjs          → сухой прогон
//   node scripts/create-website-redesign-page.cjs --apply  → создаёт
//
...
const DATA = JSON.parse(fs.readFileSync(path.resolve(__dirname, "../drafts/page-website-redesign.json"), "utf8"));
