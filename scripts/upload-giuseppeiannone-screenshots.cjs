// scripts/upload-giuseppeiannone-screenshots.cjs
//
// Uploads the giuseppeiannone.it case-study screenshots to Sanity as image assets
...
//
// Images live in drafts/screenshots-giuseppeiannone/ and are uploaded in the
// numeric order of their filenames (1-…, 2-…, … 8-…).
//
// Usage:
//   node scripts/upload-giuseppeiannone-screenshots.cjs --dry-run   list what would be uploaded
//   node scripts/upload-giuseppeiannone-screenshots.cjs             upload
//
...
const DIR = path.resolve(__dirname, "../drafts/screenshots-giuseppeiannone");
