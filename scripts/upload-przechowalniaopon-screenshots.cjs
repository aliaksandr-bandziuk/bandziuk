// scripts/upload-przechowalniaopon-screenshots.cjs
//
// Uploads the przechowalniaopon.pl case-study screenshots to Sanity as image assets
...
//
// Images live in drafts/screenshots-przechowalniaopon/ and are uploaded in the
// numeric order of their filenames (1-…, 2-…, … 12-…).
//
// Usage:
//   node scripts/upload-przechowalniaopon-screenshots.cjs --dry-run   list what would be uploaded
//   node scripts/upload-przechowalniaopon-screenshots.cjs             upload
//
...
const DIR = path.resolve(__dirname, "../drafts/screenshots-przechowalniaopon");
