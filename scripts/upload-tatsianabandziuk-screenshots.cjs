// scripts/upload-tatsianabandziuk-screenshots.cjs
//
// Uploads the tatsianabandziuk case-study screenshots to Sanity as image assets
...
//
// Images live in drafts/screenshots-tatsianabandziuk/ and are uploaded in the
// numeric order of their filenames (1-… … 9-…; the preview photo tatsianabandziuk-00.png sorts first).
//
// Usage:
//   node scripts/upload-tatsianabandziuk-screenshots.cjs --dry-run   list what would be uploaded
//   node scripts/upload-tatsianabandziuk-screenshots.cjs             upload
//
...
const DIR = path.resolve(__dirname, "../drafts/screenshots-tatsianabandziuk");
