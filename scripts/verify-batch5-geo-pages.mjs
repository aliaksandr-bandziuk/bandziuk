...
const PAGES = {
  balticsEn: `${BASE}/services/locations/seo-for-baltic-markets`,
  balticsPl: `${BASE}/pl/oferty/lokalizacje/pozycjonowanie-na-rynki-baltyckie`,
  balticsRu: `${BASE}/ru/uslugi/lokacii/prodvizhenie-na-rynki-baltii`,
  australiaEn: `${BASE}/services/locations/seo-for-australian-market`,
  australiaPl: `${BASE}/pl/oferty/lokalizacje/pozycjonowanie-na-rynek-australijski`,
  australiaRu: `${BASE}/ru/uslugi/lokacii/prodvizhenie-na-avstraliyskiy-rynok`,
...
async function inspect(pg, url) {
  ...
  return pg.evaluate(() => {
    ...
    return {
      ...
      balticsLinkOnPage: !!document.querySelector('a[href*="seo-for-baltic-markets"], a[href*="pozycjonowanie-na-rynki-baltyckie"], a[href*="prodvizhenie-na-rynki-baltii"]'),
      australiaLinkOnPage: !!document.querySelector('a[href*="seo-for-australian-market"], a[href*="pozycjonowanie-na-rynek-australijski"], a[href*="prodvizhenie-na-avstraliyskiy-rynok"]'),
...
async function main() {
  ...
  for (const [key, url] of Object.entries(PAGES)) {
    ...
    try {
      ...
      console.log("Baltics link:", r.balticsLinkOnPage, "| Australia link:", r.australiaLinkOnPage);
  ...
  for (const key of ["balticsEn", "balticsPl", "balticsRu", "australiaEn", "australiaPl", "australiaRu"]) {
    const r = results[key];
    if (!r) continue;
