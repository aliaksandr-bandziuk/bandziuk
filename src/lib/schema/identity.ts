...
export function personNode(): Graph {
  return {
    ...
    name: PERSON_NAME,
    url: SITE_URL,
    jobTitle: "SEO Consultant and Web Developer",
    description:
      "Independent SEO consultant and web developer. Runs SEO, technical SEO and AI search visibility for businesses in Europe, the UK and the US, and builds multilingual websites on Next.js and headless CMS, without an agency layer.",
    knowsAbout: [
...
export function organizationNode(): Graph {
  return {
    ...
    "@id": ORG_ID,
    name: PERSON_NAME,
    alternateName: "Bandziuk — SEO & Web Development",
    url: SITE_URL,
    description:
      "SEO, AI search visibility and website development for businesses in Europe. Work in English, Polish and Russian, done by one specialist.",
